...
from oracle.kalshi import KalshiDatabase, KalshiImporter
from oracle.kalshi.client import KalshiClient
...
def main() -> None:
    ...
    try:
        if args.command == "markets":
            print(json.dumps(KalshiClient().markets(category=args.category), indent=2))
